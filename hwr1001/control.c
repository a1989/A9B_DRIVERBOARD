...
//	if(!At93c66b_WriteAll(0x03, arrMsg))
//	{
//			printf ("\r\n Write ALL Failed:%s", arrMsg);
//			return;
//	}
	
//	if(!At93c66b_ReadByte(0xF0, &eep_driver_id, arrMsg))
//	{
//			printf ("\r\n Read ID Failed:%s", arrMsg);
//			return;
//	}
//	
//	if(!At93c66b_ReadByte(0xF1, &eep_motor_torque, arrMsg))
//	{
//			printf ("\r\n Read ID Failed:%s", arrMsg);
//			return;
//	}
//	
//	if(!At93c66b_ReadByte(0xF2, &eep_motor_step_value, arrMsg))
//	{
//			printf ("\r\n Read ID Failed:%s", arrMsg);
//			return;
//	}
...
//	
//	if(!At93c66b_WriteByte(0xF0, 0xA3, arrMsg))
//	{
//			printf ("\r\n Write ID Failed:%s", arrMsg);
//			return;
//	}

//	if(!At93c66b_WriteWord(0x03, 0xAA, arrMsg))
//	{
//			printf ("\r\n Write ID Failed:%s", arrMsg);
//			return;
//	}

//	if(!At93c66b_ReadWord(0x03, &eep_driver_id, arrMsg))
//	{
//			printf ("\r\n Read ID Failed:%s", arrMsg);
//			return;
//	}
